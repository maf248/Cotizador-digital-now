    ...
    facebookAds: Object.freeze({
        implementation: Object.freeze({
            ...
            intermediate: Object.freeze({
                ...
                skillsAcquired: Object.freeze(["Analista de Marketing Digital", "Diseñador Gráfico"]),
                skillsPrices: Object.freeze([skills.prices[0], skills.prices[5]]),
                content: Object.freeze(["<ul><li>Creación de cuenta de Facebook Ads.</li><li>Implementación de pixel de facebook para usar públicos como usuarios que ya entraron a tu sitio web o usuarios similares a los ya entraron a tu sitio web.</li><li>Creación de estructura de campaña para invertir un 70% en usuarios nuevos (No entraron a tu sitio ni a tus redes sociales) y un 30% en usuarios que ya entraron a tu sitio web o ya interactuaron con tus redes sociales.</li><li>Creación de dashboard de Google Data Studio (<a href='https://datastudio.google.com/u/0/reporting/0BzjchXrR5ZQca013LXdWZzQ4cEU/page/UwsTB/preview' target='_blank' rel='noreferrer noopener'>Ver ejemplo</a>)</li><li>Medición de conversiones (Acciones que querés que el usuario haga en tu sitio web, como una compra online o completar un formulario).</li><li>Redacción de textos diferentes de manera estratégica (10 textos en total) teniendo en cuenta si los usuarios ya entraron a la web o no.</li></ul>", "<ul><li>Se harán piezas creativas diferentes (2 sets de piezas gráficas en formatos cuadrado y vertical, 4 en total), teniendo en cuenta si los usuarios ya entraron a la web o no.</li><li><a href='https://drive.google.com/drive/folders/14atx8oJwDeypPzA49ISyET6KsONJZfPk?usp=sharing' target='_blank' rel='noreferrer noopener'>Ver ejemplos de entregables</a></li></ul>"])
            }),
            advanced: Object.freeze({
