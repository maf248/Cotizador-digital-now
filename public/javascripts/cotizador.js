    ...
    if ((googleSearchAds.checked || googleDisplayAds.checked || facebookAds.checked || conversionWeb.checked || (disenoWeb.checked && (landingPage.checked || wordpress.checked || customWebsite.checked || ecommerceWeb.checked || logoMarca.checked))) && !completeFormValidate.includes(false)) {
        ...
        if (googleSearchAds.checked) {
            ...
            services.googleSearchAds.maintenance.idSkillsAcquired.forEach((skill, i) => {
                ...
                /*--Se genera la descripcion de mantenimiento mensual para este servicio en el plan seleccionado---*/
                maintenanceContent += `<ul><li>${services.googleSearchAds.maintenance.hours[i]} horas de ${services.googleSearchAds.maintenance.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.googleSearchAds.maintenance.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.googleSearchAds.maintenance.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.googleSearchAds.maintenance.content[i]}</ul>`;
            })
            ...
            services.googleSearchAds.implementation.idSkillsAcquired.forEach((skill, i) => {
                ...
                /*--Se genera la descripcion de implementación para este servicio en el plan seleccionado---*/
                implementationContent += `<ul><li>${services.googleSearchAds.implementation.hours[i]} horas de ${services.googleSearchAds.implementation.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.googleSearchAds.implementation.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.googleSearchAds.implementation.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.googleSearchAds.implementation.content[i]}</ul>`;
            })
        ...
        if (googleDisplayAds.checked) {
            ...
            services.googleDisplayAds.maintenance.idSkillsAcquired.forEach((skill, i) => {
                ...
                /*--Se genera la descripcion de mantenimiento mensual para este servicio en el plan seleccionado---*/
                maintenanceContent += `<ul><li>${services.googleDisplayAds.maintenance.hours[i]} horas de ${services.googleDisplayAds.maintenance.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.googleDisplayAds.maintenance.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.googleDisplayAds.maintenance.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.googleDisplayAds.maintenance.content[i]}</ul>`;
            })
            ...
            services.googleDisplayAds.implementation.idSkillsAcquired.forEach((skill, i) => {
                ...
                /*--Se genera la descripcion de implementación para este servicio en el plan seleccionado---*/
                implementationContent += `<ul><li>${services.googleDisplayAds.implementation.hours[i]} horas de ${services.googleDisplayAds.implementation.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.googleDisplayAds.implementation.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.googleDisplayAds.implementation.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.googleDisplayAds.implementation.content[i]}</ul>`;
            })
        ...
        if (facebookAds.checked) {
            ...
            services.facebookAds.maintenance.idSkillsAcquired.forEach((skill, i) => {
                ...
                /*--Se genera la descripcion de mantenimiento mensual para este servicio en el plan seleccionado---*/
                maintenanceContent += `<ul><li>${services.facebookAds.maintenance.hours[i]} horas de ${services.facebookAds.maintenance.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.facebookAds.maintenance.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.facebookAds.maintenance.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.facebookAds.maintenance.content[i]}</ul>`;
            })
            ...
            services.facebookAds.implementation.idSkillsAcquired.forEach((skill, i) => {
                ...
                /*--Se genera la descripcion de implementación para este servicio en el plan seleccionado---*/
                implementationContent += `<ul><li>${services.facebookAds.implementation.hours[i]} horas de ${services.facebookAds.implementation.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.facebookAds.implementation.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.facebookAds.implementation.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.facebookAds.implementation.content[i]}</ul>`;
            })
        ...
        if (disenoWeb.checked) {
            ...
            if (landingPage.checked) {
                ...
                services.disenoWeb.maintenance.idSkillsAcquired.forEach((skill, i) => {
                    ...
                    /*--Se genera la descripcion de mantenimiento mensual para este servicio en el plan seleccionado---*/
                    maintenanceContent += `<ul><li>${services.disenoWeb.maintenance.hours[i]} horas de ${services.disenoWeb.maintenance.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.disenoWeb.maintenance.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.disenoWeb.maintenance.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.disenoWeb.maintenance.content[i]}</ul>`;
                })
                ...
                services.disenoWeb.implementation.basic.idSkillsAcquired.forEach((skill, i) => {
                    ...
                    /*--Se genera la descripcion de implementación para este servicio en el plan seleccionado---*/
                    implementationContent += `<ul><li>${services.disenoWeb.implementation.basic.hours[i]} horas de ${services.disenoWeb.implementation.basic.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.disenoWeb.implementation.basic.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.disenoWeb.implementation.basic.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.disenoWeb.implementation.basic.content[i]}</ul>`;
            ...
            if (wordpress.checked) {
                ...
                services.disenoWeb.implementation.intermediate.idSkillsAcquired.forEach((skill, i) => {
                    ...
                    /*--Se genera la descripcion de implementación para este servicio en el plan seleccionado---*/
                    implementationContent += `<ul><li>${services.disenoWeb.implementation.intermediate.hours[i]} horas de ${services.disenoWeb.implementation.intermediate.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.disenoWeb.implementation.intermediate.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.disenoWeb.implementation.intermediate.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.disenoWeb.implementation.intermediate.content[i]}</ul>`;
                })
            ...
            if (customWebsite.checked) {
                ...
                services.disenoWeb.implementation.advanced.idSkillsAcquired.forEach((skill, i) => {
                    ...
                    /*--Se genera la descripcion de implementación para este servicio en el plan seleccionado---*/
                    implementationContent += `<ul><li>${services.disenoWeb.implementation.advanced.hours[i]} horas de ${services.disenoWeb.implementation.advanced.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.disenoWeb.implementation.advanced.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.disenoWeb.implementation.advanced.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.disenoWeb.implementation.advanced.content[i]}</ul>`;
                })
            ...
            if (ecommerceWeb.checked) {
                ...
                services.disenoWeb.implementation.ecommerce.idSkillsAcquired.forEach((skill, i) => {
                    ...
                    /*--Se genera la descripcion de implementación para este servicio en el plan seleccionado---*/
                    implementationContent += `<ul><li>${services.disenoWeb.implementation.ecommerce.hours[i]} horas de ${services.disenoWeb.implementation.ecommerce.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.disenoWeb.implementation.ecommerce.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.disenoWeb.implementation.ecommerce.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.disenoWeb.implementation.ecommerce.content[i]}</ul>`;
                })
            ...
            if (logoMarca.checked) {
                ...
                services.disenoWeb.implementation.logoYMarca.idSkillsAcquired.forEach((skill, i) => {
                    ...
                    /*--Se genera la descripcion de implementación para este servicio en el plan seleccionado---*/
                    implementationContent += `<ul><li>${services.disenoWeb.implementation.logoYMarca.hours[i]} horas de ${services.disenoWeb.implementation.logoYMarca.skillsAcquired[i]} a ${responseApi ? responseApi[skill].averageHourlyRate : services.disenoWeb.implementation.logoYMarca.skillsPrices[i][countrySupplier.value].averagePrice} USD la hora <small>(Precio promedio obtenido en base a ${responseApi ? responseApi[skill].averageTotalUsers : services.disenoWeb.implementation.logoYMarca.skillsPrices[i][countrySupplier.value].averageTotal} freelancers de ${countrySupplier.options[countrySupplier.selectedIndex].text} de la plataforma <a href='https://www.freelancer.com' target='_blank' rel='noreferrer noopener'>freelancer.com</a>)</small>, que hace lo siguiente:</li> ${services.disenoWeb.implementation.logoYMarca.content[i]}</ul>`;
                })
