    ...
    googleSearchAds: Object.freeze({
        ...
        maintenance: Object.freeze({
            basic: Object.freeze({
                ...
                skillsAcquired: Object.freeze(["Analista de Marketing Digital"]),
                skillsPrices: Object.freeze([skills.prices[0]]),
                content: Object.freeze(["<ul><li>Cambios solicitados por el cliente (Sin que supere el tiempo contratado)</li><li>1 cambio por mes para intentar mejorar la performance como modificar el presupuesto, url finales, texto de anuncios, palabras clave (Búsquedas en las que aparecés), ubicación geográfica y concordancias (qué tan amplio es el abanico de búsquedas similares a tus palabras clave en el cual aparecés, podés ver más sobre las concordancias en el siguiente <a href='https://digitalnow.com.ar/google-ads-como-funciona-y-para-que-sirve/' target='_blank' rel='noreferrer noopener'>link</a>). A fin de mes el cliente puede ver un análisis sobre cómo impactó ese cambio.</li></ul>"])
            }),
            intermediate: Object.freeze({
                hours: Object.freeze([4]),
                skillsAcquired: Object.freeze(["Analista de Marketing Digital"]),
                skillsPrices: Object.freeze([skills.prices[0]]),
                content: Object.freeze(["<ul><li>Cambios solicitados por el cliente (Sin que supere el tiempo contratado)</li><li>Incluye 2 cambios por mes para intentar mejorar la performance como modificaciones en el presupuesto, url finales, texto de anuncios, palabras clave (Búsquedas en las que aparecés), ubicación geográfica y concordancias (qué tan amplio es el abanico de búsquedas similares a tus palabras clave en el cual aparecés, podés ver más sobre las concordancias en el siguiente <a href='https://digitalnow.com.ar/google-ads-como-funciona-y-para-que-sirve/' target='_blank' rel='noreferrer noopener'>link</a>). Cada 15 días el cliente puede ver un análisis sobre cómo impactaron los cambios.</li></ul>"])
            }),
            advanced: Object.freeze({
                hours: Object.freeze([8]),
                skillsAcquired: Object.freeze(["Analista de Marketing Digital"]),
                skillsPrices: Object.freeze([skills.prices[0]]),
                content: Object.freeze(["<ul><li>Cambios solicitados por el cliente (Sin que supere el tiempo contratado)</li><li>Incluye 4 cambios por mes para intentar mejorar la performance como modificaciones en el presupuesto, url finales, texto de anuncios, palabras clave (Búsquedas en las que aparecés), ubicación geográfica y concordancias (qué tan amplio es el abanico de búsquedas similares a tus palabras clave en el cual aparecés, podés ver más sobre las concordancias en el siguiente <a href='https://digitalnow.com.ar/google-ads-como-funciona-y-para-que-sirve/' target='_blank' rel='noreferrer noopener'>link</a>). Semanalmente el cliente puede ver un análisis sobre cómo impactaron los cambios.</li></ul>"])
            })
        })
    }),
    googleDisplayAds: Object.freeze({
